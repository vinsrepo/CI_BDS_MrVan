...
jQuery(function($) {
    ...
    ULTRA_SETTINGS.mailboxInbox = function() {
        ...
        $('.mail_list .open-view').click(function(e) {
            window.location = '/lienhe/xemlienhe/'+$(this).parent().attr('data-id')+'?region=12-1';
        });
        $('.mail_list .open-view2').click(function(e) {
            window.location = '/dangtin/xemtinnhan/'+$(this).parent().attr('data-id')+'?region=12-2';
        });
        $('.mail_list .open-view3').click(function(e) {
            window.location = '/trangchu/xemdangky/'+$(this).parent().attr('data-id')+'?region=12-3';
        });

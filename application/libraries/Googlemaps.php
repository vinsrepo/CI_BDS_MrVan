...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyAncygDLD4qxYy5Uw6vPdz_KH_qOCJDL8U';// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $scrollwheel				= '';						// If set to FALSE will disable zooming by scrolling of the mouse wheel

...
<div class="div_menulogin">
    ...
    <div id="boxLogin">
        <div class="form-group">
            ...
            <input name="password" type="password" id="txtUserName" class="form-control" autocomplete="off" />
        </div> 
        <div class="form-group">
            <label>Nhập lại mật khẩu mới <span class="text-danger">*</span></label>
            <input name="repassword" type="password" id="txtUserName" class="form-control" autocomplete="off" />
        </div>
        <div class="item item-btn">
            <div class="content-itembtn">
                <button class="btnLogin btn btn-success btn-sm" type="submit"><?php echo $this->lang->line('lable_Send');?></button> 
            </div>
        </div>
    </div>
</div>

...
<?php $this->load->view("admin/statut_thongbao");?>
                       ...
                       <option value="1" <?php if($email['TrangThai']=='1'){ echo "selected";}?>><?php echo $this->lang->line('lable_DaKichHoat');?></option>
                      <option value="0" <?php if($email['TrangThai']=='0'){ echo "selected";}?>><?php echo $this->lang->line('lable_ChuaKichHoat');?></option>
                   </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-8">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control input-lg" name="TieuDe" id="TieuDe" value="<?php if(isset($email['TieuDe'])){echo $email['TieuDe'];}else{echo set_value('TieuDe');}?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        if(isset($email['TieuDe'])){
            $NoiDung=$email['GiaTri'];
        }else{

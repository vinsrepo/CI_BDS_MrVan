...
<? include APPPATH.'modules/lienhe/views/left_tab.php'; ?>
                                        ...
                                        <div class="mail_content">
                                            ...
                                            <div class="row" style="margin-bottom: 10px;">
                                                <div class="col-md-7 col-sm-7 col-xs-7">
                                                    ...
                                                    <h3 class="mail_head">Quản lý email đăng ký <sup><?php echo ($totalrow!=''||$totalrow!=0?"($totalrow)":'');?></sup></h3>
        ...
        { 
            ...
            echo ' <tr class="unread" data-id="'.$member['ID'].'">
                                                            <td class=""><input class=" skin-square-green" type="checkbox" name="XoaDuLieu[]" value="'.$member['ID'].'" id="Xoa'.$member['ID'].'"></td>
                                                            <td class=""><div class="star"><i class="fa fa-star icon-xs icon-orange"></i></div></td>
                                                            <td class="open-view3">'.$member['txtEmailRegister'].'</td>
                                                            <td class="open-view3"><span class="msgtext">'.$HangXe['TieuDe'].' - '.$member['hddECity'].' - '.$member['hddEDist'].'</span></td>
                                                            <td class="open-view3"><span class="msg_time">'.date("H:i d-m-Y", strtotime($member['NgayGui'])).'</span></td>
                                                            <td style="width:20px"><a href="javascript://" class="btn btn-danger btn-sm" onclick="Delete('.$member['ID'].');"><i class="fa fa-trash-o"></i> Xóa</a></td>   
                                                        </tr> 
            ';
        }
        }else{

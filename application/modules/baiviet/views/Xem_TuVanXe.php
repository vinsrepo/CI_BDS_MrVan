        ...
        <div class="center">
           <div class="list-content">
             <ul class="grid12-12">
                 ...
                 <li><a href="/tu-van-xe" title="<?php echo $this->lang->line('lable_TuVanXe');?>"><span><? echo $this->lang->line('lable_TuVanXe');?></span></a> <span class="mpx-arr-thin-right"></span></li> 
...
<div class="newssame">
    ...
    <div class="content-newssame">
        <ul>
        <?
$tinlienquan=Modules::run('baiviet/tinlienquan','TuVanXe');
foreach($tinlienquan as $news){
?>
<li>
                    <a href="<? echo base_url();?>tu-van-xe/<? echo $news['IDBaiViet'];?>/<? echo stripUnicode($news['TieuDe']);?>.html" title="<? echo $news['TieuDe'];?>"><? echo $news['TieuDe'];?> <i>(<? echo date('d/m/Y', strtotime($news['NgayGui']));?>)</i> </a>
                </li>
<?
}
?>

        ...
        <div class="center">
           <div class="list-content">
             <ul class="grid12-12">
                 ...
                 <li><a href="/danh-gia-xe" title="<?php echo $this->lang->line('lable_DanhGiaXe');?>"><span><? echo $this->lang->line('lable_DanhGiaXe');?></span></a> <span class="mpx-arr-thin-right"></span></li> 
...
<div class="newssame">
    ...
    <div class="content-newssame">
        <ul>
        <?
$tinlienquan=Modules::run('baiviet/tinlienquan','DanhGiaXe');
foreach($tinlienquan as $news){
?>
<li>
                    <a href="<? echo base_url();?>danh-gia-xe/<? echo $news['IDBaiViet'];?>/<? echo stripUnicode($news['TieuDe']);?>.html" title="<? echo $news['TieuDe'];?>"><? echo $news['TieuDe'];?> <i>(<? echo date('d/m/Y', strtotime($news['NgayGui']));?>)</i> </a>
                </li>
<?
}
?>

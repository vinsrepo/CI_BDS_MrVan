...
<?php $this->load->view("admin/statut_thongbao");?>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left"><?php echo $this->lang->line('lable_quanlythenap');?></h2>
        ...
        { 
            ...
            echo '<tr>
                  ...
                  <td>'.$member['menhgia'].'</td>
                  <td>'.$member['loaithe'].'</td>
                  <td>'.$member['sopin'].'</td> 
                  <td>'.$member['soserial'].'</td> 
                  <td>'.date('d-m-Y',strtotime($member['NgayNap'])).'</td> 
